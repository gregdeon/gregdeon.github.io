...
\BLOCK{for publication_type, publication_list in publications.items()}
    \BLOCK{if publication_list|rejectattr("hide_in_cv")|list|length > 0}
...
\begin{itemize}
	\item ICLR 2023
	\item EC 2022
	\item NeurIPS 2021 (workshops)
    \item CHI 2018 (late-breaking work track), 2019, 2022
    \item CSCW 2019
\end{itemize}

Conference volunteering roles:
\begin{itemize}
	\item NeurIPS Women in Machine Learning (WiML) workshop: 2019, 2020
\end{itemize}
\clearpage
